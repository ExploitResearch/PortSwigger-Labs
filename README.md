...
- [API Pentesting](./API_Pentesting/README.md)
- [XXE](./XXE/README.md)
- [Extentions](./Extentions/README.md)
...
[**GET vs POST**](/173cb39bf5c94cefb3b333feaaa28d5d#1bc92dd3c4e64b46a12124165a67e920)**  **A `GET` request contains all parameters in the URL, a `POST` request keeps them in the body of the message.
