...
The official solution confirms: With Burp running, log in and attempt to buy the leather jacket. The order is rejected because you don't have enough store credit. In the proxy histor
...
**Official lab:** Low-level logic flaw
