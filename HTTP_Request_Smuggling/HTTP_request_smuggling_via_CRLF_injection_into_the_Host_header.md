# HTTP request smuggling via CRLF injection into the Host header

### Goal -

Solve the PortSwigger lab: HTTP request smuggling via CRLF injection into the Host header
