...
2. Identify a vulnerable endpoint
...
The PortSwigger lab description confirms this: "This lab is vulnerable to client-side desync attacks because the server ignores the Content-Length header on requests to some endpoints. You can exploit this to induce a victim's browser to disclose i"
...
- The PortSwigger lab confirms: "This lab is vulnerable to client-side desync attacks because the server ignores the Content-Length h"
