...
2. Probe for vulnerable endpoints
                
                
                    
                        
                            From the Proxy &gt; HTTP history, send the GET / request to B
...
The PortSwigger lab description confirms this: "This lab is vulnerable to CL.0 request smuggling attacks. The back-end server ignores the Content-Length header on requests to some endpoints."
...
- The PortSwigger lab confirms: "This lab is vulnerable to CL.0 request smuggling attacks. The back-end server ignores the Content-Le"
