...
**Official lab:** Exfiltrating sensitive data via server-side prototype pollution

**PortSwigger:** https://portswigger.net/web-security/prototype-pollution/server-side/lab-exfiltrating-sensitive-data-via-server-side-prototype-pollution
