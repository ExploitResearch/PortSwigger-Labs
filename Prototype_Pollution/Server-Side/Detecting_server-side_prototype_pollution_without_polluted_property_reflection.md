...
**Official lab:** Detecting server-side prototype pollution without polluted property reflection

**PortSwigger:** https://portswigger.net/web-security/prototype-pollution/server-side/lab-detecting-server-side-prototype-pollution-without-polluted-property-reflection
