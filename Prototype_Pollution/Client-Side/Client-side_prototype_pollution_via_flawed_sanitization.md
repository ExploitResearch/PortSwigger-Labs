...
2. Load the lab in Burp's built-in browser.
                        
                    
                    
                        
                            Enable DOM Invader and enable the proto
...
The PortSwigger lab description confirms this: "This lab is vulnerable to DOM XSS via client-side prototype pollution. This is due to a gadget in a third-party library, which is easy to miss due to the minified source code. Although it's technicall"
...
- The PortSwigger lab confirms: "This lab is vulnerable to DOM XSS via client-side prototype pollution. This is due to a gadget in a "
