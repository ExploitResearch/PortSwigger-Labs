...
**Official lab:** Server-side template injection in a sandboxed environment

**PortSwigger:** https://portswigger.net/web-security/server-side-template-injection/exploiting/lab-server-side-template-injection-in-a-sandboxed-environment
